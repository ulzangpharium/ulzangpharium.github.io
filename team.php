...
<head>
    ...
    <meta content="tours and travel in kenya" name="keywords">
    ...
    <div class="row gx-0">
        <div class="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
            <div class="d-inline-flex align-items-center" style="height: 45px;">
                <small class="me-3 text-light"><i class="fa fa-map-marker-alt me-2"></i>Transnational house door 4, Mama Ngina street</small>
...
<!-- Top bar End -->
 ...
 <div class="position-relative h-100"><!--add to other pages-->
                        <img class="img-fluid position-absolute w-100 h-100" src="images\new img\Images\Walking Safari at Sunrise.jpg" alt="east african safari" style="object-fit: cover;">
        ...
        <div class="container py-5">
            <div class="row justify-content-center py-5">
                <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
                    ...
                    <p class="fs-4 text-white mb-4 animated slideInDown">"Expert's at Adventure"</p>
    ...
    <div class="container">
        ...
        <div class="row g-4">
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="team-item">
                    <div class="overflow-hidden">
                        <img class="img-fluid" src="images/img2/guides chakabay.png" alt="african safari deals">
                    </div>
                    <div class="position-relative d-flex justify-content-center" style="margin-top: -19px;">
                        ...
                        <a class="btn btn-square mx-1" href=""target="blank"><i class="fab fa-instagram"></i></a>
                    </div>
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="team-item">
                    <div class="overflow-hidden">
                        <img class="img-fluid" src="images\img2\guide 2.jpg" alt="east african safari">
                    </div>
                    <div class="position-relative d-flex justify-content-center" style="margin-top: -19px;">
                        <a class="btn btn-square mx-1" href=""target="blank"><i class="fab fa-facebook-f"></i></a>
                        <a class="btn btn-square mx-1" href=""target="blank"><i class="fab fa-twitter"></i></a>
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="team-item">
                    <div class="overflow-hidden">
                        <img class="img-fluid" src="images\img2\guide 3.jpg" alt="tours and travel in kenya">
                    </div>
                    <div class="position-relative d-flex justify-content-center" style="margin-top: -19px;">
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                <div class="team-item">
                    <div class="overflow-hidden">
                        <img class="img-fluid" src="images\img2\guide 4.jpg" alt="best africa safari">
                    </div>
                    <div class="position-relative d-flex justify-content-center" style="margin-top: -19px;">
                        <a class="btn btn-square mx-1" href=""target="blank"><i class="fab fa-facebook-f"></i></a>
                        <a class="btn btn-square mx-1" href=""target="blank"><i class="fab fa-twitter"></i></a>
                    ...
                    <div class="text-center p-4">
                        <h5 class="mb-0">Karanja Njiri</h5>
