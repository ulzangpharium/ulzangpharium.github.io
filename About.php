...
<head>
    <meta charset="utf-8">
    <title>Chakabay adventure</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="africa best tours" name="keywords">
    <meta content="tours and travel companies in kenya" name="description">
...
<body>
    ...
    <div class="position-relative h-100"><!--add to other pages-->
                        <img class="img-fluid position-absolute w-100 h-100" src="images\img2\IMG\banner-masai-mara-game-reserve.jpg" alt="african safari vacation" style="object-fit: cover;">
            ...
            <div class="container py-5">
                <div class="row justify-content-center py-5">
                    <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
                        ...
                        <p class="fs-4 text-white mb-4 animated slideInDown">"Showing you Africa, one National park at a time."</p>
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="img-fluid position-absolute w-100 h-100" src="images\dawn-w-FmUx8z_Tz4A-unsplash.jpg" alt="family african safari" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <p class="mb-4">Travel with the Best East African Tour Operators. We provide tailor-made and socially responsible safaris that imprint a beautiful experience.
                        Our promise  to you since 2018 hearty, quality and unique service that gives you value for money.</p>
