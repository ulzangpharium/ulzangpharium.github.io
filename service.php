...
<body>
    ...
    <div class="position-relative h-100"><!--add to other pages-->
                        <img class="img-fluid position-absolute w-100 h-100" src="images/img2/IMG/maasai mara2.jpg" alt="" style="object-fit: cover;">
            ...
            <div class="container py-5">
                <div class="row justify-content-center py-5">
                    <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
                        ...
                        <p class="fs-4 text-white mb-4 animated slideInDown">"Journey's, Explorations and Adventures"</p>
