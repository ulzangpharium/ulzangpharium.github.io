	...
	<header class="header">
			...
			<div class="top-header">
				<div class="container">
					<ul class="tp-hd-lft wow fadeInLeft animated" data-wow-delay=".5s">
						...
						<li class="prnt"><a href="adprofile.php">My Profile</a></li>
		...
		} else 
		{
			...
			<div class="top-header" style="background-color: #14141F;">
				<div class="container">
					<ul class="tp-hd-lft wow fadeInLeft animated" data-wow-delay=".5s">
						<li class="hm"><a href="admin/adindex.php">Admin Login</a></li>
					</ul>
					<ul class="tp-hd-rgt wow fadeInRight animated" data-wow-delay=".5s"> 
			...
			<nav class="navbar navbar-inverse" role="navigation">
				...
				<div id="main-nav" class="collapse navbar-collapse adeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">
					<ul class="nav navbar-nav" id="mainNav">
						...
						<!--<li><a href="package.php" class="scroll-link">Packages</a></li>-->
						<li><a href="destination.php" class="scroll-link">Destination</a></li>
						<!--<li><a href=".php" class="scroll-link">Contact Us</a></li>-->
					</ul>
				</div>
				<!--/.navbar-collapse-->
			</nav>
	...
	<section id="packages" class="secPad">
		<div class="container">
				...
				<div class="container"> 
					...
					if($query->rowCount() > 0)
					{
						...
						{ 
							...
							<div class="selectroom_top" style="background-color:#f0cfa8 ;">
								<div class="col-md-4 selectroom_left wow fadeInLeft animated" data-wow-delay=".5s">
									<img src="admin/pacakgeimages/<?php echo htmlentities($result->PackageImage);?>" class="img-responsive" alt="best african safari">
								</div>
			...
			<div class="clearfix"></div>
                            ...
                            <!--add booking system-->
							<form name="book" method="post" class="img-fluid position-absolute"  style="background-color:#f0cfa8 ;">  
										...
										<ul>
											...
											{?>
												<li class="spe" align="center">
													<button type="submit" name="submit2" class="btn-primary btn"style="background-color:#9ED034;">Book</button>
												</li>
												<?php 
											} else {?>
												<li class="sigi" align="center" style="margin-top: 1%">
													<a href="#" data-toggle="modal" data-target="#myModal4"  class="btn-primary btn"style="background-color:#9ED034;" > Book</a>
												</li>
												<?php
											} ?>
											<div class="clearfix"></div>
